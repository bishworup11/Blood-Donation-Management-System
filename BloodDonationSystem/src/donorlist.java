...
//                String phone=rs.getString(7);
           ...
           String city=(rs.getString(10));
            String address=(rs.getString(11));
                ...
                String toData[]={id,name,blood,dob,mobile,gender,email,city,address};
                tb.addRow(toData);
                
            }
            jLabel3.setText("TOTAL DONOR "+String.valueOf(tb.getRowCount())) ;
        } catch (Exception ex) {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Name", "Blood Group", "Date Of Birth", "Mobile", "Gender", "Email", "City", "Address"
            }
        ));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 320, 1021, 197));

        jLabel2.setFont(new java.awt.Font("Algerian", 1, 36)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("ALL  DONOR  LIST");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 180, 340, -1));

        jLabel3.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("TOTAL AVAILABLE DONAR");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 580, -1, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/hm.jpg"))); // NOI18N
